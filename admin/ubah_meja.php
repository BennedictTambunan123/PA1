            ...
            <div class="contact-form">
              <form id="contact" action="" method="post">
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <fieldset>
                      <p class="text-left"> Harga Pemesanan Meja </p>
                      <input  value="<?= $detail['harga'] ?>"name="harga" type="number" class="form-control" id="date" placeholder="Jumlah Pengunjung" required="" min="1">
                    </fieldset>
                  </div>
