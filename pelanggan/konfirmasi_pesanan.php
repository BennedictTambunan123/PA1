      ...
      <nav class="navbar navbar-expand-lg">
       ...
       <div class="container">
        <div class="containerr">
            ...
            <p class="text-right text-danger">*Jika Pesanan Dikonfirmasi Mohon untuk datang sesuai dengan waktu pemesanan meja!!! </p>
        ...
        $sql = "SELECT *
        FROM pembayaran
        INNER JOIN pemesanan_meja
        ON pembayaran.id_pemesanan = pemesanan_meja.id Where id_users = $id ;";
        ...
        <td scope="row">
        <a href="detail_pesanan.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-warning">Detail Pesanan</button></a> <br> <br>
        ...
        <?php }} else{
         ?> 
         <tr>
         <td colspan='8' class="text-center">Tidak ada Pesanan Yang Dibayar</td>
     </tr> <?php
        } ?>
        </table>
            </div>
